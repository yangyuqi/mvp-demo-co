...
public class SearchCourseAdapter extends BaseQuickAdapter<SearchBean, BaseViewHolder> {
...
//                }
                return SearchBean.NOT_LEARN;
            }
        });
        //Step.2
        getMultiTypeDelegate()
                .registerItemType(SearchBean.HAS_LEARN, R.layout.layout_popular_course_haslearn_item)
                .registerItemType(SearchBean.NOT_LEARN, R.layout.layout_popular_course_unlearn_item);
    }
