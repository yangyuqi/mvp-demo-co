package com.wxjz.module_base.view;
...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextColor = Color.parseColor("#4A4A4A");
...
//        drawWavePath(canvas);
    ...
    private void drawLetters(Canvas canvas) {
        ...
        mLettersPaint.setColor(getResources().getColor(android.R.color.transparent));
