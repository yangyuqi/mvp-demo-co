...
//                                    h = (int) (scale * h);
//                                } else if (w > h && w > 0) {
//                                    float scale = (ScreenUtil.dip2px(context.getResources().getDimension(R.dimen.dp_270)) / w);
//                                    w = (int) (scale * w);
//                                    h = (int) (scale * h);
//                                }
                                float scale = (ScreenUtil.dip2px(context.getResources().getDimension(R.dimen.dp_270)) / w);
                                w = (int) (scale * w);
                                h = (int) (scale * h);
//                                int w = ScreenUtil.dip2px(context.getResources().getDimension(R.dimen.dp_270));
//                                // h = ScreenUtil.dip2px(context.getResources().getDimension(R.dimen.dp_150));
//                                int h = (int) (w *((double)horigin/worigin));
                    ...
                    final CharSequence charSequence = Html.fromHtml(sources, imageGetter, null);
