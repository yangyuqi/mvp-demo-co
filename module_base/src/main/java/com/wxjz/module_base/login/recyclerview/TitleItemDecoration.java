...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int TITLE_TEXT_COLOR = Color.parseColor("#4A4A4A");
    private static int mTitleTextSize;


    public TitleItemDecoration(Context context, List<SchoolItemBean> data) {
        super();
        mData = data;
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, context.getResources().getDimension(R.dimen.dp_8), context.getResources().getDisplayMetrics());
        mTitleTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, context.getResources().getDimension(R.dimen.sp_6), context.getResources().getDisplayMetrics());
