package com.wxjz.module_aliyun.aliyun.view.sectionlist;
...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        for (Map.Entry<String, Section> entry : sections.entrySet()) {
            ...
            // check if schoolId is in this section
        ...
        throw new IndexOutOfBoundsException("Invalid schoolId");
    }
    ...
    /**
     * Returns the Section ViewType of an item based on the schoolId in the adapter.
     *
     * @param position schoolId in the adapter
    ...
    /**
     * Returns the Section object for a schoolId in the adapter.
     *
     * @param position schoolId in the adapter
     * @return Section object for that schoolId
     */
    ...
    /**
     * Return the item schoolId relative to the section.
     *
     * @param position schoolId of the item in the adapter
     * @return schoolId of the item in the section
     */
    ...
    /**
     * Return the section schoolId in the adapter.
     *
     * @param tag unique identifier of the section
     * @return schoolId of the section in the adapter
     */
    ...
    /**
     * Helper method that receives schoolId in relation to the section, and returns the schoolId in
     * the adapter.
     *
     * @param tag      unique identifier of the section
     * @param position schoolId of the item in the section
     * @return schoolId of the item in the adapter
     */
    ...
    /**
     * Helper method that returns the schoolId of header in the adapter.
     *
     * @param tag unique identifier of the section
     * @return schoolId of the header in the adapter
     */
    ...
    /**
     * Helper method that returns the schoolId of footer in the adapter.
     *
     * @param tag unique identifier of the section
     * @return schoolId of the footer in the adapter
     */
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemInserted}.
     *
     * @param tag      unique identifier of the section
     * @param position schoolId of the item in the section
     */
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemRangeInserted}.
     *
     * @param tag           unique identifier of the section
     * @param positionStart schoolId of the first item that was inserted in the section
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemRemoved}.
     *
     * @param tag      unique identifier of the section
     * @param position schoolId of the item in the section
     */
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemRangeRemoved}.
     *
     * @param tag           unique identifier of the section
     * @param positionStart previous schoolId of the first item that was removed from the section
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemChanged}.
     *
     * @param tag      unique identifier of the section
     * @param position schoolId of the item in the section
     */
    ...
    /**
     * Helper method that calculates the relative header schoolId in the adapter and calls
    ...
    /**
     * Helper method that calculates the relative footer schoolId in the adapter and calls
     * {@link #notifyItemChanged}.
     *
     * @param tag unique identifier of the section
     */
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemRangeChanged}.
     *
     * @param tag           unique identifier of the section
     * @param positionStart schoolId of the first item that was changed in the section
    ...
    /**
     * Helper method that receives schoolId in relation to the section, calculates the relative
     * schoolId in the adapter and calls {@link #notifyItemMoved}.
     *
     * @param tag          unique identifier of the section
     * @param fromPosition previous schoolId of the item in the section
     * @param toPosition   new schoolId of the item in the section
     */
    ...
    /**
     * Helper method that calls {@link #notifyItemChanged} with the schoolId of the {@link Section.State}
     ...
     * the schoolId of the {@link Section.State} view holder in the adapter. Useful to be called after
    ...
    /**
     * Helper method that calls {@link #notifyItemInserted} with the schoolId of the section's
    ...
    /**
     * Helper method that calls {@link #notifyItemRemoved} with the schoolId of the section's
     * header in the adapter. Useful to be called after changing the visibility of the section's
    ...
    /**
     * Helper method that calls {@link #notifyItemRangeInserted} with the schoolId of the section
     ...
     *
     * @param tag                     unique identifier of the section
     * @param previousSectionPosition previous section schoolId
     */
